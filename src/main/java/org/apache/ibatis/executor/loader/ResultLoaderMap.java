 ...
 * @author Franta Mejta
 *
 * 使用loaderMap字段保存对象中延时加载的属性以及对应的ResultLoader对象之间的关系
 */
public class ResultLoaderMap {

    //集合中key为大写的属性名，value为LoadPair对象
    ...
    public boolean load(String property) throws SQLException {
        ...
        if (pair != null) {
            pair.load();//调用LoadPir.load()方法执行延时加载
            return true;
        }
        return false;
    }
    ...
    public void loadAll() throws SQLException {
        ...
        for (String methodName : methodNames) {
            load(methodName);//加载loadMap集合中记录的全部属性
        }
    }
    ...
    public static class LoadPair implements Serializable {
        ...
        public void load(final Object userObject) throws SQLException {
            ...
            //调用ResultLoader.loadResult()方法执行延时加载，并且加载得到的嵌套对象设置到外层对象中
